...
<head>
    ...
    <link rel="shortcut icon" href="/images/alti.png">
...
<div class="navbar navbar-inverse navbar-fixed-top" >
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="Home.html"><img src="/images/alti.png" height="12%" width="12%">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav pull-right">
                <a href="signin.ftl">
                    <li class="active"><button type="button" class="btn btn-warning">Sign In</button></li>
                </a>
            </ul>
        </div><!--/.nav-collapse -->
    </div>
...
<div class="container">
    ...
    <div class="row">
        ...
        <article class="col-xs-12 maincontent">
            ...
            <div class="col-md-6 col-md-offset-0 col-sm-8 col-sm-offset-2" style="margin-top:8%">
                <div class=" panel-default">
                    <div class="panel-body">


                        <div class="top-margin">
                            <label style="color:#FF4500;font-size: 250%; font-family: "Times New Roman, Times, serif;">Watch Your Favourite movie.</label>

                        </div>
                        <div class="top-margin">
                            <h2 style="font-family:"Comic Sans MS, cursive, sans-serif;"><b>Any where Any time</b></h2>

                        </div>
                        <div class="top-margin"><a href="signup.html">
                            <button class="btn btn-danger col-md-12" type="submit">Don't Have Account? Join Us</button></a>
                        </div>
